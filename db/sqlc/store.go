...
// provides all the function to execute db queries and transactions
type Store struct {
	db *sql.DB
	*Queries
}
...
func (store *Store) TransferTxn(ctx context.Context, args TransferTxnParam) (TransferTxnResult, error) {
